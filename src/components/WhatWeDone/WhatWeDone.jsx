...
const WhatWeDone = () => {
  return (
    <div >
      <div className="max-w-[1440px] mx-auto relative pt-[50px] lg:pt-[120px]">
  ...
  <path opacity="0.3" d="M5.84348 8.63845C12.3249 13.5942 28.9695 23.9592 43.6965 25.7729C62.1052 28.0399 81.8655 17.9041 94.1073 23.281C106.349 28.6579 106.386 45.4966 122.178 46.3332C137.969 47.1698 144.008 31.4697 158.043 31.1133" stroke="#B98E75" stroke-width="1.5" stroke-dasharray="8 8"/>
